...
export function RegisterPage() {
    ...
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface px-6 py-10 font-body text-on-surface selection:bg-primary-dim selection:text-on-primary">
